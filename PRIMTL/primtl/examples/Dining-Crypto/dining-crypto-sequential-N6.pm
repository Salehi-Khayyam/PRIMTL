...
module crypt
	...
	// flip coins
	[] s1=-6 & coin1=0 -> pr : (coin1'=1) & (s1'=-5) + 1.0-pr : (coin1'=2) & (s1'=-5);
    [] s1=-5 & coin2=0 -> pr : (coin2'=1) & (s1'=-4) + 1.0-pr : (coin2'=2) & (s1'=-4);
    [] s1=-4 & coin3=0 -> pr : (coin3'=1) & (s1'=-3) + 1.0-pr : (coin3'=2) & (s1'=-3);
    [] s1=-3 & coin4=0 -> pr : (coin4'=1) & (s1'=-2) + 1.0-pr : (coin4'=2) & (s1'=-2);
    [] s1=-2 & coin5=0 -> pr : (coin5'=1) & (s1'=-1) + 1.0-pr : (coin5'=2) & (s1'=-1);
    [] s1=-1 & coin6=0 -> pr : (coin6'=1) & (s1'=0) + 1.0-pr : (coin6'=2) & (s1'=0);
	...
	[] s1=5 & coin6>0 & coin1>0 & coin6=coin1    & (pay!=p6) -> (s1'=6) & (agree6'=1);
	[] s1=5 & coin6>0 & coin1>0 & !(coin6=coin1) & (pay!=p6) -> (s1'=6);
	[] s1=5 & coin6>0 & coin1>0 & coin6=coin1    & (pay=p6)  -> (s1'=6);
	[] s1=5 & coin6>0 & coin1>0 & !(coin6=coin1) & (pay=p6)  -> (s1'=6) & (agree6'=1);
...
init   
	s1=-6 & coin1=0&agree1=0 & coin2=0&agree2=0 & coin3=0&agree3=0 & coin4=0&agree4=0 
		  & coin5=0&agree5=0 & coin6=0&agree6=0
endinit
