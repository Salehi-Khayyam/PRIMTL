...
// This method is calculated via Java_sparse_PrismSparse_PS_1SuccessorStates in the interleak package
JNIEXPORT jintArray JNICALL Java_sparse_PrismSparse_PS_1PredecessorStates
(
JNIEnv *env,
jclass cls,
jint src,
