...
public class Declaration extends ASTElement
{
	...
	public static int OBSERVABILITY_DEFAULT = 0;
	public static int OBSERVABILITY_OBSERVABLE = 1;
	public static int OBSERVABILITY_SECERT = 2;
	
	private int observabilityType = Declaration.OBSERVABILITY_DEFAULT;
	...
	public Declaration(String name, DeclarationType declType)
	{
		...
		setStart(null);
		this.observabilityType = Declaration.OBSERVABILITY_DEFAULT;
	}
	
	public void setObservabilityType(int observabilityType)
	{
		this.observabilityType = observabilityType;
//		System.out.println("observability of \"" + this.name + "\" setted to " + this.observabilityType);
	}
	
	public int getObservabilityType()
	{
		return observabilityType;
	}
